#Понимаю что метод update_rating не доделан, но просто уже нет сил в это вникать без обучаещего материала.
#в пройденном курсе нет про эти тонкости ничего, что реально могло бы помочь. Потратил три дня, хотя при наличии
#материала для изучения ушел бы час наверное максимум. Понятно, что надо учиться решать разные задачи, но я могу еще неделю
#потратить на этот метод и не факт, что добьюсь необходимого результата, поэтому принял решение учиться дальше.
